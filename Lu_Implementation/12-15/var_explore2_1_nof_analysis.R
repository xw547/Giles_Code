...
explor2_rho1 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho1.csv"))[,-c(1,6)]
explor2_rho3 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho3.csv"))[,-c(1,6)]
explor2_rho5 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho5.csv"))[,-c(1,6)]
explor2_rho7 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho7.csv"))[,-c(1,6)]
explor2_rho9 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho9.csv"))[,-c(1,6)]
...
var_explor2_rho1 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho1.csv"))[, 6]
var_explor2_rho3 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho3.csv"))[, 6]
var_explor2_rho5 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho5.csv"))[, 6]
var_explor2_rho7 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho7.csv"))[, 6]
var_explor2_rho9 = data.matrix(read.csv("./var_explore_2_1_nof_rf_large_rho9.csv"))[, 6]
