...
sim_100_withforest = foreach(s = 1:160, .combine = "rbind")%dopar%{
  ...
  c(mean(zero_term), mean(first_term), mean(second_term), mean(third_term))
}

write.csv(sim_100_withforest, "~/Working/Ning/Giles_Project_1/Code/Lu_Implementation/12-15/explore_2_1_rf_large_rho9.csv" )
...
write.csv(sim_100_withforest, "~/Working/Ning/Giles_Project_1/Code/Lu_Implementation/12-15/explore_2_1_rf_large_rho7.csv" )
...
write.csv(sim_100_withforest, "~/Working/Ning/Giles_Project_1/Code/Lu_Implementation/12-15/explore_2_1_rf_large_rho5.csv" )
...
write.csv(sim_100_withforest, "~/Working/Ning/Giles_Project_1/Code/Lu_Implementation/12-15/explore_2_1_rf_large_rho3.csv" )
...
write.csv(sim_100_withforest, "~/Working/Ning/Giles_Project_1/Code/Lu_Implementation/12-15/explore_2_1_rf_large_rho1.csv" )
