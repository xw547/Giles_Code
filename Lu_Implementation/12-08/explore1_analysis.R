...
explor1_rho1 = data.matrix(read.csv("./explore_1_lm_large_rho1.csv"))[,-1]
explor1_rho3 = data.matrix(read.csv("./explore_1_lm_large_rho3.csv"))[,-1]
explor1_rho5 = data.matrix(read.csv("./explore_1_lm_large_rho5.csv"))[,-1]
explor1_rho7 = data.matrix(read.csv("./explore_1_lm_large_rho7.csv"))[,-1]
explor1_rho9 = data.matrix(read.csv("./explore_1_lm_large_rho9.csv"))[,-1]
