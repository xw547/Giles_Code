...
rho_3 <- read.table("./true_sim_160_withforest_3rho_200N.csv", sep=" ")
rho_3 <- data.matrix(rho_3)

rho_5 <- read.table("./true_sim_160_withforest_5rho_200N.csv", sep=" ")
rho_5 <- data.matrix(rho_5)

rho_7 <- read.table("./true_sim_160_withforest_7rho_200N.csv", sep=" ")
rho_7 <- data.matrix(rho_7)

rho_9 <- read.table("./true_sim_160_withforest_9rho_200N.csv", sep=" ")
...
estimate_plot = ggplot(data = plot_data, aes(x = rho))+  ylim(0,3)+
