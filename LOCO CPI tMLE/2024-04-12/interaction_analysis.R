...
linear = 25*(1-seq(.1, .9, .1)^2)*5/4


svm_data = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/2024-04-12/inter_svm_linear_1000.csv")[, -1]
lm_data = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/2024-04-12/inter_lm_linear_1000.csv")[, -1]
rf_data = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/2024-04-12/inter_rf_linear_1000.csv")[, -1]
...
ggplot(model_bias_long, aes(x = Rho, y = Bias, color = Model, group = Model)) +
  ...
  labs(title = "Bias of tMLE vs Plugin under linear true model",
       x = "Rho",
       y = "Bias")  
ggsave("./inter_svm_linear.png", width = 1200, height = 936, units = "px", bg ="white")
...
ggplot(model_bias_long, aes(x = Rho, y = Bias, color = Model, group = Model)) +
  ...
  labs(title = "Bias of tMLE vs Plugin under linear true model",
       x = "Rho",
       y = "Bias")  
ggsave("./inter_lm_linear.png", width = 1200, height = 936, units = "px", bg ="white")
...
ggplot(model_bias_long, aes(x = Rho, y = Bias, color = Model, group = Model)) +
  ...
  labs(title = "Bias of tMLE vs Plugin under linear true model",
       x = "Rho",
       y = "Bias")  
ggsave("./inter_rf_linear.png", width = 1200, height = 936, units = "px", bg ="white")
