{
  ...
  full_model_trunc_1_1 <- lm(output~0+., data = full_data_trunc_1_1[1:n_1,])
  full_model_trunc_1_1_res <- lm(output~0+., data = full_data_trunc_1_1[1:n_1,])
  reduced_model_trunc_1_1 <-  lm(output~0+., data = reduced_data_trunc_1_1[1:n_1,])
  ...
  full_model_trunc_2_2 <- lm(output~0+., data = full_data_trunc_2_2[1:n_1,])
  full_model_trunc_2_2_res <- lm(output~0+., data = full_data_trunc_2_2[1:n_1,])
  reduced_model_trunc_2_2 <-  lm(output~0+., data = reduced_data_trunc_2_2[1:n_1,])
  ...
  full_model_trunc = lm(output~0+., data = full_data_trunc[1:n_1,])
  full_model_trunc_est = lm(output~0+., data = full_data_trunc[1:n_1,])
  ...
  ### Now we fit the models.
  full_model_trunc_2 = lm(output~0+., data = full_data_trunc_2[1:n_1,])
  full_model_trunc_est_2 = lm(output~0+., data = full_data_trunc_2[1:n_1,])
