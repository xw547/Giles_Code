...
linear_data = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/2024-04-12/full_copula_rf_linear_1000.csv")[, -1]
...
ggsave("./copula_rf_coverage.png", width = 1200, height = 936, units = "px", bg ="white")
