{
  ...
  cc_1 = ((2*full_data[1:n_1, 1]
           - full_model$fitted
           - reduced_model$fitted)*
            (full_model$fitted - reduced_model$fitted))
  cc_2 =  ((2*full_data_2[1:n_1, 1]
            - full_model_2$fitted
            - reduced_model_2$fitted)*
             (full_model_2$fitted - reduced_model_2$fitted) )
  cc   = (cc_1 + cc_2)/2
  ...
  trunc_index_1_1 <- trunc(full_model_trunc_1_1$fitted, 
                           reduced_model_trunc_1_1$fitted)
  trunc_index_2_1 <- trunc(full_model_trunc_2_1_pred,  
                           reduced_model_trunc_2_1_pred)
  
  
  
  eif_h =  2*(full_model_trunc_1_1$fitted - reduced_model_trunc_1_1$fitted)[trunc_index_1_1]
  regress_frame = data.frame(y = Y_cv_1_1[[3]][trunc_index_1_1], 
                             curr_offset = qlogis(full_model_trunc_1_1$fitted[trunc_index_1_1]), 
                             obs = eif_h)
  
  
  epsilon_model = glm(y ~ 0 + offset(curr_offset) + obs, data = regress_frame,  family = "quasibinomial")
  full_model_trunc_1_1$fitted = epsilon_model$fitted
  ...
  epsilon_model$fitted = predict(epsilon_model, newdata = validataion_frame, type = "response")
  
  epsilon_model$fitted = epsilon_model$fitted * dist_1 + min_1
  
  
  bb_1 = ((2*full_data_2[1:n_1, 1][trunc_index_2_1]
           - epsilon_model$fitted
           - predict(reduced_model, reduced_data_2[1:n_1, ])[trunc_index_2_1])*
            (epsilon_model$fitted - predict(reduced_model, reduced_data_2[1:n_1, ])[trunc_index_2_1]))
  ...
  trunc_index_2_2 <- trunc(full_model_trunc_2_2$fitted, 
                           reduced_model_trunc_2_2$fitted)
  trunc_index_1_2 <- trunc(full_model_trunc_1_2_pred,  
                           reduced_model_trunc_1_2_pred)
  
  
  
  eif_h =  2*(full_model_trunc_2_2$fitted - reduced_model_trunc_2_2$fitted)[trunc_index_2_2]
  regress_frame = data.frame(y = Y_cv_2_2[[3]][trunc_index_2_2], 
                             curr_offset = qlogis(full_model_trunc_2_2$fitted[trunc_index_2_2]), 
                             obs = eif_h)
  ...
  epsilon_model$fitted = epsilon_model$fitted * dist_2 + min_2
  
  bb_2 = ((2*full_data[1:n_1, 1][trunc_index_1_2]
           - epsilon_model$fitted
           - predict(reduced_model_2, reduced_data[1:n_1, ])[trunc_index_1_2])*
            (epsilon_model$fitted - predict(reduced_model_2, reduced_data[1:n_1, ])[trunc_index_1_2]))
  ...
  trunc_index = full_model_trunc$fitted>.005&full_model_trunc$fitted<(1-.005)
  full_model_trunc$fitted = full_model_trunc$fitted[trunc_index]
  Y_trunc = Y_trunc[trunc_index]
  
  
  eif_h = c(full_model_trunc$fitted - reduced_model_trunc$fitted[trunc_index])
  
  regress_frame = data.frame(y = Y_trunc, curr_offset = qlogis(full_model_trunc$fitted), obs = eif_h)
  epsilon_model = glm(y ~ 0 + offset(curr_offset) + obs, data = regress_frame,  family = "quasibinomial")
  
  
  
  epsilon_model$fitted = epsilon_model$fitted * dist + min
  
  aa_1 = ((2*full_data[1:n_1, 1][trunc_index]
           - epsilon_model$fitted
           - reduced_model$fitted[trunc_index])*
            (epsilon_model$fitted - reduced_model$fitted[trunc_index]))
  dd_1 = ((2*full_data_trunc[1:n_1, 1][trunc_index]
           - full_model_trunc_est$fitted[trunc_index]
           - reduced_model_trunc$fitted[trunc_index])*
            (full_model_trunc_est$fitted[trunc_index] - reduced_model_trunc$fitted[trunc_index]))*dist^2
  ### Bounded Logistic 
  y_2 = Y_2[1:n_1]
  ...
  trunc_index = full_model_trunc_2$fitted>.005&full_model_trunc_2$fitted<(1-.005)
  full_model_trunc_2$fitted = full_model_trunc_2$fitted[trunc_index]
  Y_trunc_2 = Y_trunc_2[trunc_index]
  
  
  eif_h = c(full_model_trunc_2$fitted - reduced_model_trunc_2$fitted[trunc_index])
  
  
  regress_frame = data.frame(y = Y_trunc_2, curr_offset = qlogis(full_model_trunc_2$fitted), obs = eif_h)
  epsilon_model = glm(y ~ 0 + offset(curr_offset) + obs, data = regress_frame,  family = "quasibinomial")
  ...
  aa_2 = ((2*full_data_2[1:n_1, 1][trunc_index]
           - epsilon_model$fitted
           - reduced_model_2$fitted[trunc_index])*
            (epsilon_model$fitted - reduced_model_2$fitted[trunc_index]))
  
  dd_2 =  ((2*full_data_trunc_2[1:n_1, 1][trunc_index]
            - full_model_trunc_est_2$fitted[trunc_index]
            - reduced_model_trunc_2$fitted[trunc_index])*
             (full_model_trunc_est_2$fitted[trunc_index] - reduced_model_trunc_2$fitted[trunc_index]))*dist_2^2
