...
full_model = gam(full_formula, data = full_data[1:n_1,])
reduced_model = gam(reduced_formula, data= reduced_data[1:n_1,])
full_model_2 = gam(full_formula, data = full_data_2[1:n_1,])
reduced_model_2 = gam(reduced_formula, data= reduced_data_2[1:n_1,])
...
naive_LOCO_2 = -mean((full_data_2[(n_1+1):n, 1]- predict(full_model_2, full_data_2[(n_1+1):n, -1]))^2 
                     - (full_data_2[(n_1+1):n, 1]- predict(reduced_model_2, reduced_data_2[(n_1+1):n, -1]))^2)
...
full_model_trunc_1_1 <- gam(full_formula, data = full_data_trunc_1_1[1:n_1,])
full_model_trunc_1_1_res <- gam(full_formula, data = full_data_trunc_1_1[1:n_1,])
reduced_model_trunc_1_1 <-  gam(reduced_formula, data = reduced_data_trunc_1_1[1:n_1,])
...
full_model_trunc_2_2 <- gam(full_formula, data = full_data_trunc_2_2[1:n_1,])
full_model_trunc_2_2_res <- gam(full_formula, data = full_data_trunc_2_2[1:n_1,])
reduced_model_trunc_2_2 <-  gam(reduced_formula, data = reduced_data_trunc_2_2[1:n_1,])
...
### Now we fit the models.
full_model_trunc = gam(full_formula, data = full_data_trunc[1:n_1,])
full_model_trunc_est = gam(full_formula, data = full_data_trunc[1:n_1,])
reduced_model_trunc = gam(reduced_formula, data= reduced_data_trunc[1:n_1,])
...
### Now we fit the models.
full_model_trunc_2 = gam(full_formula, data = full_data_trunc_2[1:n_1,])
full_model_trunc_est_2 = gam(full_formula, data = full_data_trunc_2[1:n_1,])
reduced_model_trunc_2 = gam(reduced_formula, data= reduced_data_trunc_2[1:n_1,])
