...
nonlinear_data = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/03-26/cv_gam_nonlinear_500.csv")[, -1]
...
ggsave("./cv_gam_nonlinear_small.png", width = 1200, height = 936, units = "px", bg ="white")
