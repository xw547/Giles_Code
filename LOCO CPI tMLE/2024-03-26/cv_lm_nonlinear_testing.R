...
X_reduced = X[,-1]
Y = 5*sin(X[,1]) + 5*cos(X[,2]) + rnorm(n, 0, 1)
...
cc =  mean((2*full_data[1:n_1, 1]
            ...
            - reduced_model$fitted.values)*
             ...
             (2*full_data_2[1:n_1, 1]
              - full_model_2$fitted.values
              - reduced_model_2$fitted.values)*
             (full_model_2$fitted.values - reduced_model_2$fitted.values) )/2
