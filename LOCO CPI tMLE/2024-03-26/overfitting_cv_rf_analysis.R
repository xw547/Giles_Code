...
nonlinear_data = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/03-26/overfitting_cv_rf_nonlinear_1000.csv")[, -1]
linear_data = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/03-26/overfitting_cv_rf_linear_1000.csv")[, -1]
naive_cv_linear = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/03-26/overfitting_naive_para_cv_rf_linear_1000.csv")[,-1]
naive_cv_nonlinear = read.csv("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/03-26/overfitting_naive_para_cv_rf_nonlinear_1000.csv")[,-1]
