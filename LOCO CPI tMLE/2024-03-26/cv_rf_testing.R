...
source("~/Working/Ning/Giles_Project_1/Code/LOCO CPI tMLE/03-26/helpers.R")
...
naive_LOCO_2 = -mean((full_data_2[(n_1+1):n, 1]- predict(full_model_2, full_data_2[(n_1+1):n, -1])$predictions)^2 
                     - (full_data_2[(n_1+1):n, 1]- predict(reduced_model_2, reduced_data_2[(n_1+1):n, -1])$predictions)^2)
